...
;window.calendar = (function(){
	...
	class Calendar{
		...
		constructor(elem, opts){
			...
			this.daysOfWeekFull = ["Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag"];
			this.daysOfWeekAbbr = ["Son", "Mon", "Die", "Mit", "Don", "Fre", "Sam"];
			this.monthsFull = ["Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"];
